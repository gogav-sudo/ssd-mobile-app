...
export default function SupervisorKnowledgeTopicScreen() {
      ...
      <SafeAreaView style={styles.safe}>
        ...
        {loading ? (
          ...
          <View style={styles.centerState}>
            ...
            <Text style={[type.bodySmall, styles.emptyText]}>В этом разделе пока нет статей</Text>
          </View>
        ) : (
          <View style={styles.list}>
            {articles.map((article) => (
              <Pressable
                ...
                onPress={() => router.push(`/supervisor/knowledge/article/${article.id}`)}
              >
