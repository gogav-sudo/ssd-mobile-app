...
// Same idea as app/employee/start-shift/uploading.tsx: photo upload + incident
// insert is a WRITE, so on timeout we surface an explicit error and let the
// person retry rather than silently continuing — we don't know whether the
// upload or insert actually landed.
